 ...
 * This can result in errors because the combo box methods are not synchronized and 
 * both the worker thread and the event dispatch thread access the combo box.
 * 
 */
...
/**
 * This runnable modifies a combo box by randomly adding and removing numbers. In order to ensure that the combo box is nor corrupted,
 * the editing operations are forwarded to the event dispatch thread.
 * @author michaelnwani
 *
 */
