...
/**
 * A program to test preference settings. The program remembers the frame positon, size, and title.
 * @author michaelnwani
 *
 */
...
class PreferencesFrame extends JFrame
{
	...
	public PreferencesFrame()
	{
		...
		final Preferences node = root.node("Welcome/preferences/PreferencesTest");
